...
export default async function Page(/*{
  ...
  return (
    <div className="w-full h-full flex items-center justify-center p-2">
      <div className="flex flex-col border-2 border-borderCard rounded lg:w-full lg:h-full p-4 gap-y-3">
        <div className="flex items-center justify-between text-black600">
          <span className="text-center">
            <h1 className="text-xl text-gray950 font-semibold inline">
              Ativos
            </h1>
            <p className="text-sm text-gray600 inline"> / Apex Unit</p>
          </span>
        ...
        <section className="flex gap-2 w-full h-full">
          <section className="border border-borderCard w-1/3 h-full text-black overflow-scroll"></section>
